...
public class GrayCode {
    ...
    public static void yarg(String prefix, int n, HashMap<String,Integer> map) {
        if (n == 0) map.put(prefix, 0);
        else {
    ...
    public static void gray(String prefix, int n, HashMap<String,Integer> map) {
        if (n == 0) map.put(prefix, 0);
        else {
